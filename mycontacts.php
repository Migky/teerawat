...
<body>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-7">
                <h1 class="display-5 text-uppercase mb-4">STUDENT ID <span class="text-primary">65130131</span></h1>
                <h5 class="display-5 text-uppercase mb-4">TEERAWAT KITTIVORAWUT</h5>
